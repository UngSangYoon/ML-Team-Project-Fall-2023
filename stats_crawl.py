...
for season in range(3, 8):
    standard_stats_url = "https://fbref.com/en/comps/9/200{0}-200{1}/stats/200{0}-200{1}-Premier-League-Stats".format(
        season, season + 1
    )
    shooting_stats_url = "https://fbref.com/en/comps/9/200{0}-200{1}/shooting/200{0}-200{1}-Premier-League-Stats".format(
        season, season + 1
    )
    goalkeeping_stats_url = "https://fbref.com/en/comps/9/200{0}-200{1}/keepers/200{0}-200{1}-Premier-League-Stats".format(
        season, season + 1
    )
    ...
    with open(
        os.path.join(output_folder, f"0{season}_0{season+1}_shooting_stat.json"),
        "w",
        encoding="utf-8",
    ) as output_file:
